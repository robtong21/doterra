...
OAuth.setupStrategy({
  ...
  config: {
    clientID: '541319557183-gq5u1rhfflsl0d9bgtf41cbb8ce9o8t7.apps.googleusercontent.com',
    // clientID: env.GOOGLE_CLIENT_ID,
    clientSecret: 'nlC5UUJ80Kr1pWVjPi6YhSDs',
...
// auth.post('/login', passport.authenticate('local', {successRedirect: '/'}))
